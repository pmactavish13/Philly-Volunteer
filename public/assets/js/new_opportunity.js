...
$(document).ready(function () {
    // if ($(".modal-title").text() == "Post New Event") {
    //     $("#newOpportunity").attr("readonly", true);
    // }
    ...
    //         return false;
    //     }
    //     if ($("#opportunitySelectInOrOut").val() === "" || $("#opportunitySelectInOrOut").val() === "Choose..." || $("#opportunitySelectInOrOut").val() === "Please select an option") {
    //         $("#opportunitySelectInOrOut").val(" Please select an option");
    //         return false;
    //     }
